/**
 * Lucide-style inline SVG path strings.
 * NO npm dep — copy-paste from lucide.dev, only paths we use.
 * Strokes inherit `currentColor`. To color: wrap in element with text-*-N class.
 *
 * Usage:
 *   <Icon name="layout-dashboard" size={16} />
 *   // or directly:
 *   <svg viewBox="0 0 24 24" ...><Fragment set:html={ICONS["layout-dashboard"]} /></svg>
 */
...
export const ICONS = {
  ...
  "send-horizontal": '<path d="M22 2 11 13"/><path d="M22 2 15 22 11 13 2 9 22 2z"/>',
  ...
  "table": '<rect width="18" height="18" x="3" y="3" rx="2"/><path d="M3 9h18"/><path d="M3 15h18"/>',

  "scraper": '<path d="M4 4h16v4H4z"/><path d="M4 12h16v4H4z"/><path d="M4 20h16"/>',
